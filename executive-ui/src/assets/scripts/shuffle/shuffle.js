...
function getItemPosition(_ref) {
  ...
  //var span = 1; // getColumnSpan(itemSize.width, gridSize, total, threshold);
  ...
  createClass(Shuffle, [{
    ...
    value: function _init() {
      ...
      if (document.readyState !== 'complete') {
        var udpate = this.update.bind(this);
    ...
    value: function _setColumns() {
      ...
      this.colWidth = columnWidth + 10;

      this._getItems().forEach(function(item) {
        item.applyCss({width: columnWidth + 'px'});
      });
    }
