...
export class ProductionIncidentsDetailStrategy extends DetailStrategyBase {
  ...
  public parse(model: MetricDetail): MetricDetailModel {
    ...
    metricDetailView.outageListModel = this.segmentationStrategy.parseOutageDetails(model.summary);
    metricDetailView.eventListModel = this.segmentationStrategy.parseEventDetails(model.summary);
    metricDetailView.operationalListModel = this.segmentationStrategy.parseOperationalMetrics(model.summary);
